...
public class StudentTests {
    ...
    private static final int NUMS2 =20;
    private static final long SEED = 10; // Static seed for experiment reproducibility. You can set it to whatever you want.
...
@Test
public void testEnsureAVLGAfterDelete() throws InvalidBalanceException, EmptyTreeException {
    tree = new AVLGTree<>(3);
   ...
   tree.delete(1);
    ...
    assertTrue("After inserting " + NUMS + " - many random elements, it was determined that our AVL-3 tree" +
            " did not satisfy the AVL-3 property!", tree.isAVLGBalanced());
    assertTrue("After inserting " + NUMS + " - many random elements, it was determined that our AVL-3 tree" +
            " did not satisfy the AVL-3 property!", tree.isBST());
	}

public void testHugeEnsureAVLGAfterDelete() throws InvalidBalanceException, EmptyTreeException{
	tree = new AVLGTree<>(3);
	 tree.insert(20);
